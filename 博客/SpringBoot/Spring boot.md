...
springboot自动配置类Thymeleaf相关默认配置
...
![1564050435497](1564050435497.png)
...
![1564040688664](1564040688664.png)

例如设置视图方法addViewControllers功能，从源码看EnableWebMvcConfiguration 继承了DelegatingWebMvcConfiguration类
...
点击该类addViewControllers 实现方法，进入WebMvcConfigurerComposite类中
...
​	MVC自动配置类中配置了  国际化Locale（区域信息对象）；LocaleResolver（获取区域信息对象）；
